...
const Form = () => {
  ...
  const handleSubmit = async(e) => {
    ...
    var v=await axios.post("http://172.17.15.232:5001/login",body, {
        headers: {
  ...
  return (
    ...
    <div className="w-[40%] h-[70%] flex flex-col rounded-xl items-center justify-center p-10 space-y-8 bg-white  shadow-md">
      <h1 className='text-center text-5xl font-semibold text-pink-500'>Welcome To LearnEasy</h1>
